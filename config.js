...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || 'ᴀᴡᴇꜱᴏꪑᴇ',
    ...
    BOT_INFO: process.env.BOT_INFO || 'ᴀᴡᴇꜱᴏꪑᴇ;ᴀᴡᴇꜱᴏꪑᴇ;972528277755;https://i.imgur.com/6oRG106.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'ᴀᴡᴇꜱᴏꪑᴇ;ᴀᴡᴇꜱᴏꪑᴇ;https://i.imgur.com/fj2WE83.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'ᴀᴡᴇꜱᴏꪑᴇ;🪲' : process.env.STICKER_DATA,
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '919777469706,0',
       DEBUG: DEBUG
};
